...
class _CategoryScreenState extends State<CategoryScreen> {
  final List<Map<String, dynamic>> _categories = [
    {'label': 'Phones', 'icon': Icons.phone_iphone, 'color': Colors.indigo},
    {'label': 'Laptops', 'icon': Icons.laptop_mac, 'color': Colors.deepPurple},
    {'label': 'Headphones', 'icon': Icons.headset, 'color': Colors.teal},
    {'label': 'Monitors', 'icon': Icons.monitor, 'color': Colors.blue},
    {'label': 'Accessories', 'icon': Icons.watch, 'color': Colors.orange},
  ];
